        ...
        <div class="topbar d-flex align-items-center">
            <nav class="navbar navbar-expand">
                <div class="topbar-logo-header">
                    <div class="">
                        <img src="https://th.bing.com/th/id/OIP.VgZqLhaTAhEZ5p7ho5oPgQHaHa?rs=1&pid=ImgDetMain" class="logo-icon" alt="logo icon">
                    </div>
                    <div class="">
                        <h4 class="logo-text">Trang Chủ</h4>
                    </div>
                </div>
                ...
                <div class="user-box dropdown">
                    <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                        ...
                        <div class="user-info ps-3">
                            <p class="user-name mb-0">{{ name_dl }}</p>
...
export default {
    ...
    mounted() {
        this.name_dl = localStorage.getItem('ten_dl')
    },
    methods: {
        dangXuat(){
            baseRequest
                .get('dai-ly/dang-xuat')
                .then((res) => {
                    if(res.data.status) {
                        toaster.success('Thông báo<br>' + res.data.message);
                        window.localStorage.removeItem('chia_khoa_16');
                        window.localStorage.removeItem('ten_dl');
                        this.$router.push('/');
                    } else {
