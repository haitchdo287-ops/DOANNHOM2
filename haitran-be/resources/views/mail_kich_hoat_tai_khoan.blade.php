                                                        ...
                                                        <table
                                                                ...
                                                                <td align="center"
                                                                    ...
                                                                    <span class="es-button-border"
                                                                        style="border-style:solid;border-color:#FFA73B;background:1px;border-width:1px;display:inline-block;border-radius:2px;width:auto"><a
                                                                            href="http://localhost:5173/dai-ly/kich-hoat-tai-khoan/{{ $hash_active }}"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                                    ...
                                                                    <a target="_blank"
                                                                        href="http://localhost:5173/dai-ly/kich-hoat-tai-khoan/{{ $hash_active }}"
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#FFA73B;font-size:18px">http://localhost:5173/dai-ly/kich-hoat-tai-khoan/{{ $hash_active }}</a>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <em><strong>tan60134@gmail.com</strong></em><br><em>Đây
