...
use App\Http\Requests\CapNhatDaiLyResquest;
...
use App\Http\Requests\ThemVaoDaiLyResquest;
...
{
    public function store(ThemVaoDaiLyResquest $request)
    {
        $id_chuc_nang = 9;
    ...
    public function update(CapNhatDaiLyResquest $request)
    {
        $id_chuc_nang = 11;
    ...
    public function actionLaylaiMK($hash_reset, LayLaiMatKhauResquest $request)
    {
