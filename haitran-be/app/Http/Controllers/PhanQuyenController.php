...
use App\Http\Requests\ThemMoiPhanQuyenResquest;
...
class PhanQuyenController extends Controller
{
    ...
    public function createData(ThemMoiPhanQuyenResquest $request){
    ...
    public function UpateData(ThemMoiPhanQuyenResquest $request)
    {
