...
use App\Http\Requests\CapNhatNhanVienResquest;
use App\Http\Requests\ThemMoiNhanVienRequest;
use App\Http\Requests\ThemMoiNhanVienResquest;
...
class NhanVienController extends Controller
{
    ...
    public function store(ThemMoiNhanVienResquest $request)
    {
        $id_chuc_nang = 19;
    ...
    public function update(CapNhatNhanVienResquest $request)
    {
        $id_chuc_nang = 21;
