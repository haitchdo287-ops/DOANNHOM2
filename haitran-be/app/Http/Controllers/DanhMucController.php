...
use App\Http\Requests\CapNhatDanhMucResquest;
use App\Http\Requests\ThemMoiDanhMucRequest;
use App\Http\Requests\ThemMoiDanhMucResquest;
...
class DanhMucController extends Controller
{
    ...
    public function store(ThemMoiDanhMucResquest $request)
    {
        $id_chuc_nang = 2;
    ...
    public function update(CapNhatDanhMucResquest $request)
    {
        $id_chuc_nang = 6;
