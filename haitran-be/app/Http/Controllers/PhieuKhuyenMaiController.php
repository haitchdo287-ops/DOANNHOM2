...
use App\Http\Requests\ThemMoiPhieuKhuyenMaiResquest;
use App\Models\PhieuKhuyenMai;
use Illuminate\Http\Request;

class PhieuKhuyenMaiController extends Controller
{
    public function store(ThemMoiPhieuKhuyenMaiResquest $request)
    {
        $id_chuc_nang = 14;
    ...
    public function update(ThemMoiPhieuKhuyenMaiResquest $request)
    {
        $id_chuc_nang = 16;
