...
use App\Http\Requests\CapNhatKhachHangResquest;
use App\Http\Requests\DoiMatKhauKhachHangRequest;
use App\Http\Requests\DoiMatKhauKhachHangResquest;
use App\Http\Requests\LayLaiMatKhauRequest;
use App\Http\Requests\LayLaiMatKhauResquest;
use App\Http\Requests\ThemMoiKhachHangRequest;
use App\Http\Requests\ThemMoiKhachHangResquest;
...
{
    public function store(ThemMoiKhachHangResquest $request)
    {
        try {
    ...
    public function actionLayLaiMatKhau($hash_reset, LayLaiMatKhauResquest $request)
    {
    ...
    public function updateTaiKhoan(CapNhatKhachHangResquest $request)
    {
        $id_chuc_nang = 26;
    ...
    public function doiMatKhauTaiKhoan(DoiMatKhauKhachHangResquest $request)
    {
        $id_chuc_nang = 28;
    ...
    public function updateMatKhau(LayLaiMatKhauResquest $request)
    {
        $khach_hang = Auth::guard('sanctum')->user();
