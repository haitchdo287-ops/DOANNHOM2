...
use App\Http\Requests\CapNhatDiaChiResquest;
use App\Http\Requests\ThemMoiDiaChiRequest;
use App\Http\Requests\ThemMoiDiaChiResquest;
...
{
    public function store(ThemMoiDiaChiResquest $request)
    {
        try {
    ...
    public function update(CapNhatDiaChiResquest $request)
    {
        $khach_hang = Auth::guard('sanctum')->user();
